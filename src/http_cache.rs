...
/// # use azure_rs::http_cache::cache_path;
/// assert_eq!(
///     cache_path(&PathBuf::from("/home/.azure_rs/cache"), "https://api.github.com/users/dwijnand/repos", "json"),
///     PathBuf::from("/home/.azure_rs/cache/v1/https/api.github.com/users/dwijnand/repos.json"),
/// );
/// assert_eq!(
///     cache_path(&PathBuf::from("/home/.azure_rs/cache"), "https://api.github.com/users/dwijnand/repos?page=2", "json"),
///     PathBuf::from("/home/.azure_rs/cache/v1/https/api.github.com/users/dwijnand/repos/6dd58bde8abb0869.json"),
/// );
/// assert_eq!(
///     cache_path(&PathBuf::from("/home/.azure_rs/cache"), "https://api.github.com/users/dwijnand/repos?page=2&per_page=5", "json"),
///     PathBuf::from("/home/.azure_rs/cache/v1/https/api.github.com/users/dwijnand/repos/d862dcd2d85cebca.json"),
/// );
/// ```
...
///
/// ```
/// # use azure_rs::http_cache::u64_to_padded_hex;
